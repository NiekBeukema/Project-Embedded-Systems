                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div id="values">
                                    ...
                                    <label>Status: </label>
                                    <div id="currentstatus">''' + rolledOutStatus + '''</div><br>
                                </div>
                            </div>
                            <div class="col-md-6 col-md-offset-2">
                                <br/>
                                Welkom op de homepagina van een Zeng ltd. rolluik domotica systeem.<br/>
                                Deze website bied u de mogelijk om diverse informatie van het rolluik te bekijken.<br/>
                                Ook heeft u de mogelijkheid om diverse instellingen van het systeem aan te passen.
                                <br/>
                                <br/>
                                U kunt onderandere:
                                <ul>
                                    <li>Het rolluik in- en uitrollen</li>
                                    <li>De temperatuur- en lichtwaarden bekijken</li>
                                    <li>De voortgang van de temperatuur- en lichtwaarden zien in twee grafieken</li>
                                    <li>De temperatuur- en lichtdrempels aanpassen</li>
                                </ul>
                            </div>
                        </div>
                        <!-- <div class="row">&nbsp;</div> -->
                        ...
                        $(document).ready(function() {
                            ...
                            function updateData() {
                                $.when(ajax1()).done(function(result) {
                                    ...
                                    if(result['rolledOutValue'] == 0) {
                                        $("#currentstatus").html('het rolluik is ingerold <img id="greenCircle"/>');
                                    } else if(result['rolledOutValue'] == 1) {
                                        $("#currentstatus").html('het rolluik is uitgerold <img id="redCircle"/>');
                                    } else {
                                        $("#currentstatus").html('de status is onbekend');
                                    }
                                    wait(1000);
                                    updateData();
                                })
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form method="post">
                                <label>Huidige lichtintensiteitsdrempel is: ''' + currentLightThreshold + '''</label>
                                <br/>
                                <label for="lightThreshold">lichtintensiteitsdrempel: </label>
                                <div class="input-control text">
                                    <input type="text" class="form-control" name="lightThreshold" value="''' + currentLightThreshold + '''"
                                    placeholder="Threshold"/>
                                </div>
                                <br/>
                                <label>Huidige temperatuur drempel is: ''' + currentTempThreshold + '''</label>
                                <br/>
                                <label for="tempThreshold">Temperatuur drempel: </label>
                                <div class="input-control text">
...
if __name__ == '__main__':
    ...
    cherrypy.quickstart(Default(), '/', 'conf.config')
